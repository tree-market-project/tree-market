...
export function useRegisterDeroID(){
    ...
    const registerDeroID = async (name:string, scid:string) =>{
        const data:any = {
            scid:registry,
            ringsize:2,
            sc_rpc:[{name:"SC_ACTION",datatype:"U",value:0},{name:"SC_ID",datatype:"H",value:registry},{name:"entrypoint",datatype:"S",value:"Register"},{name:"name",datatype:"S",value:name},{name:"key",datatype:"S",value:scid},{name:"owner",datatype:"S",value:""},{name:"transferCost",datatype:"U",value:1},{name:"data",datatype:"S",value:scid},{name:"datatype",datatype:"S",value:"DeroID"}],
            transfers:[{scid:dns,burn:1000,destination:"dero1qyd8s5twqsdq907wlxangumusjrqc5yx0ja84wv6ns286haurguh2qgrh6nhd"}]
        }
