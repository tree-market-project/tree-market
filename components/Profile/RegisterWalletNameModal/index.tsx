...
const RegisterWalletNameModal:React.FC<{setShow:any}> = ({setShow})=>{
    ...
    <div className="modal-box relative pb-4">
      ...
      <div className="modal_content grid gap-4 p-4 md:p-6">
        ...
        <h3 className="font-bold text-lg">Add Wallet Name</h3>
        ...
        <div className="notification info flex items-center border-2 border-gray-200 bg-amber-50 p-3 rounded-sm gap-2">
          ...
          <div className="text-sm">Give your Dero wallet a name. This name can be used in place of your address when accepting payments.</div>
...
export default RegisterWalletNameModal